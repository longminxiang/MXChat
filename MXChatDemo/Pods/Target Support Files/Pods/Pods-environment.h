...
#define COCOAPODS_VERSION_PATCH_EGOCache 4
...
// MXChat
#define COCOAPODS_POD_AVAILABLE_MXChat
#define COCOAPODS_VERSION_MAJOR_MXChat 0
#define COCOAPODS_VERSION_MINOR_MXChat 1
#define COCOAPODS_VERSION_PATCH_MXChat 0
